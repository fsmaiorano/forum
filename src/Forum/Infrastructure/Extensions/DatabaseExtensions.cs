                ...
                else
                {
                    ...
                    if (pendingMigrationsList.Any())
                    {
                        ...
                        catch (PostgresException pgEx) when (pgEx.SqlState == "42P07")
                        {
                            ...
                            Console.WriteLine(
                                "This indicates the migration history is out of sync with the actual database state.");
                            Console.WriteLine("\nTo fix this, run the following SQL command:");
                            Console.WriteLine(
                                $"INSERT INTO \"__EFMigrationsHistory\" (\"MigrationId\", \"ProductVersion\") VALUES ('{pendingMigrationsList.First()}', '10.0.0');");
