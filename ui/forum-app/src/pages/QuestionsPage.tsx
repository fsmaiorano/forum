...
export function QuestionsPage() {
    ...
    if (loading) {
        return (
            <div
                className="min-h-screen bg-linear-to-br from-stone-100 to-stone-200 dark:from-stone-900 dark:to-stone-950 flex items-center justify-center">
                <div>Loading...</div>
            </div>
        )
    }
            ...
            <main className="container mx-auto px-4 py-8">
                    ...
                    {myQuestions.length > 0 ? (
                        <div className="grid gap-4">
                            {myQuestions.map(question => (
                                <QuestionCard
                                    ...
                                    setAnswerContent={(content) => setAnswerContents(prev => ({
                                        ...prev,
                                        [question.id]: content
                                    }))}
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    You haven't asked any questions yet. Click the "Ask Question" button to get started.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    )}
                ...
                <section>
                    ...
                    {otherQuestions.length > 0 ? (
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>No questions from others yet</CardTitle>
                                <CardDescription>
                                    There are no questions from other users at the moment.
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    )}
